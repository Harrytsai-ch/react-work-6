...
function App() {
  ...
  useEffect(() => {
    getProducts();
    productDetailModalInstance.current = new Modal(productDetailModal.current, {
      backdrop: false,
    });
    getCartInfo();
  }, []);
              ...
              <div className='modal-content'>
                ...
                <div className='modal-footer'>
                  ...
                  <button
                    ...
                    disabled={isWaiting}
                    onClick={() =>
                      addMultipleProductToCart(tmpProduct.id, productQty)
                    }
                  >
                    放入購物車
                  </button>
        ...
        <div className='my-5 row justify-content-center'>
          ...
          >
            <div className='mb-3'>
              ...
              />
              {errors.email && (
                <p className='text-start invalid-feedback'>
